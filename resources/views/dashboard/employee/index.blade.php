         ...
         <div class="row emp-dash-detail">
            ...
            <div class="col-xl-7 col-lg-12 col-md-12 e-d-tasks-projects-events">
                ...
                @if (in_array('notices', $activeWidgets))
                    ...
                    @endisset
                    @isset($interviewSchedule)
                            <!-- EMP INTERVIEW SCHEDULE START -->
                            <div class="col-md-12">
                                <div class="mt-4 mb-3 b-shadow-4 rounded bg-white">
                                    <!-- NOTICE HEADING START -->
                                    <div class="d-flex align-items-center b-shadow-4 p-20">
                                        <p class="mb-0 f-18 f-w-500">@lang('modules.interview-candidate.interviewtitle')</p>
                                    </div>
                                    <!-- NOTICE HEADING END -->
                                    <!-- NOTICE DETAIL START -->
                                    <div class="b-shadow-4 cal-info scroll ps" data-menu-vertical="1" data-menu-scroll="1"
                                       ...
                                       @foreach ($interviewSchedule as $schedule)
                                            <div class="card border-0 b-shadow-4 p-20 rounded-0">
                                                <div class="card-horizontal">
                                                    <div class="card-header m-0 p-0 bg-white rounded">
                                                        <x-date-badge :month="date('M',strtotime($schedule->interview_date))"
                                                            :date="date('d',strtotime($schedule->interview_date))" />
                                                    </div>
                                                    <div class="card-body border-0 p-0 ml-3">
                                                        <h4 class="card-title f-14 font-weight-normal text-capitalize mb-0">
                                                            <a target="_blank" href="{{route('interview-candidates.show', [$schedule->interview_candidate_id])}}" class="text-darkest-grey">@lang('modules.interview-candidate.candidate_name'):
                                                                     {{ $schedule->candidateName->name }}</a>
                                                        </h4>
                                                        <h4 class="card-title f-14 font-weight-normal text-capitalize mb-0">
                                                                <a target="_blank" href="{{route('interview-candidates.show', [$schedule->interview_candidate_id])}}" class="text-darkest-grey">@lang('modules.interview-candidate.interviewtype'):
                                                                     {{ $schedule->interview_type }}</a>
                                                        </h4>
                                                        <h4 class="card-title f-14 font-weight-normal text-capitalize mb-0">
                                                                <a target="_blank" href="{{route('interview-candidates.show', [$schedule->interview_candidate_id])}}" class="text-darkest-grey">@lang('modules.interview-candidate.time'):
                                                                     {{ $schedule->interview_time }}</a>
                                                        </h4>
                                                        <div class="task_view">
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink" tabindex="0" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(23px, 26px, 0px);">
                                                                    <a data-toggle="modal" data-id="{{ $schedule }}" data-target="#edit_schedule_form" class="dropdown-item leave-action edit_interview_schedule_btn" data-leave-id="18" data-leave-action="approved" href="javascript:;">
                                        ...
                                        <div class="align-items-center d-flex flex-column text-lightest p-20 w-100">
                                            <svg class="svg-inline--fa fa-ticket-alt fa-w-18 f-21 w-100" aria-hidden="true" focusable="false" data-prefix="fa" data-icon="ticket-alt" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg=""><path fill="currentColor" d="M128 160h320v192H128V160zm400 96c0 26.51 21.49 48 48 48v96c0 26.51-21.49 48-48 48H48c-26.51 0-48-21.49-48-48v-96c26.51 0 48-21.49 48-48s-21.49-48-48-48v-96c0-26.51 21.49-48 48-48h480c26.51 0 48 21.49 48 48v96c-26.51 0-48 21.49-48 48zm-48-104c0-13.255-10.745-24-24-24H120c-13.255 0-24 10.745-24 24v208c0 13.255 10.745 24 24 24h336c13.255 0 24-10.745 24-24V152z"></path></svg><!-- <i class="fa fa-ticket-alt f-21 w-100"></i> Font Awesome fontawesome.com -->

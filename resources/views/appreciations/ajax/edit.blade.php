                                ...
                                <x-forms.input-group>
                                    ...
                                    <select class="form-control select-picker" name="award" id="appreciation_type"
                                        ...
                                        @foreach ($appreciationTypes as $appreciationType)
                                            <option @if($appreciation->award_id == $appreciationType->id) selected @endif  data-content="<i class='bi bi-{{ $appreciationType->awardIcon->icon }}' style='color: {{ $appreciationType->color_code }}'></i> {{ ucwords($appreciationType->title) }}" value="{{ $appreciationType->id }}">

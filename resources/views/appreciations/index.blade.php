...
@section('filter-section')
    ...
    <x-filters.filter-box>
        ...
        <!-- DATE END -->
        <div class="select-box d-flex pr-2 border-right-grey border-right-grey-sm-0">
            <p class="mb-0 pr-3 f-14 text-dark-grey d-flex align-items-center">@lang('modules.appreciations.awardTo')</p>
            <select class="form-control select-picker" id="awardTo" data-live-search="true" data-container="body" data-size="8">
